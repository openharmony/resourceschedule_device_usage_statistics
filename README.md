...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p493294018574"><a name="p493294018574"></a><a name="p493294018574"></a>Query the current application or the grouping of the application corresponding to the specified bundlename.</p>
...
>9.  Query the current application or the grouping of the application corresponding to the specified bundlename；
