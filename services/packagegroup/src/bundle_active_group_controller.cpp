...
int32_t BundleActiveGroupController::SetAppGroup(const std::string& bundleName, const int32_t userId,
...
int32_t BundleActiveGroupController::QueryAppGroup(const std::string& bundleName, const int32_t userId)
{
    if (bundleName.empty()) {
