...
const int GROUP_CONTROL_REASON_MASK = 0xFF00;
const int GROUP_CONTROL_REASON_DEFAULT = 0x0100;
const int GROUP_CONTROL_REASON_TIMEOUT = 0x0200;
const int GROUP_CONTROL_REASON_USAGE = 0x0300;
const int GROUP_CONTROL_REASON_FORCED = 0x0400;
const int GROUP_CONTROL_REASON_CALCULATED = 0x0500;
const int GROUP_EVENT_REASON_MASK = 0x00FF;
const int GROUP_EVENT_REASON_SYSTEM = 0x0001;
const int GROUP_EVENT_REASON_NOTIFY_SEEN = 0x0002;
const int GROUP_EVENT_REASON_USER_INTERACTION = 0x0003;
const int GROUP_EVENT_REASON_FOREGROUND = 0x0004;
const int GROUP_EVENT_REASON_BACKGROUND = 0x0005;
const int GROUP_EVENT_REASON_ALIVE_TIMEOUT = 0x0006;
const int GROUP_EVENT_REASON_LONG_TIME_TASK_STARTTED = 0x0007;
const int GROUP_EVENT_REASON_CALCULATED_RESTORED = 0x0008;
}
}
}
#endif