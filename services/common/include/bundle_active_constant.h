...
const int MODULE_NAME_COLUMN_INDEX = 2;
const int MODULE_PACKAGE_COLUMN_INDEX = 3;
const int MODULE_LAST_TIME_COLUMN_INDEX = 4;
const int MODULE_USED_COUNT_COLUMN_INDEX = 5;
const int MODULE_COMBINED_INFO_COLUMN_INDEX = 2;
const int FORM_NAME_COLUMN_INDEX = 3;
const int FORM_DIMENSION_COLUMN_INDEX = 4;
const int FORM_ID_COLUMN_INDEX = 5;
const int FORM_LAST_TIME_COLUMN_INDEX = 6;
const int FORM_COUNT_COLUMN_INDEXT = 7;
...
const std::string BUNDLE_ACTIVE_DB_MODULE_PACKAGE = "modulePackage";
const std::string BUNDLE_ACTVIE_DB_MODULE_COMBINED_INFO = "moduleCombinedInfo";
