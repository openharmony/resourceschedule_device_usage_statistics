...
const std::string RDB_STORE_COLUMN_TYPE_INT = "INTEGER";
const std::string BUNDLE_ACTIVE_DB_UID = "uid";
const std::string BUNDLE_ACTIVE_DB_FIRST_USE_TIME = "firstUseTime";
